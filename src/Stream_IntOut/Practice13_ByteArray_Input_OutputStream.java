...
public class Practice13_ByteArray_Input_OutputStream {
    public static void main(String... args) {
        ...
        try {
            ...
            // byte []buff = new byte[1024];//改为1024就不会发生byte数组截断,因为源文件字节数小于1024，进而读出来了全部的字节数。
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();//写到内存里边。
